...
\abstract{Ongoing controversies surrounding transformative agreements as a means of transitioning journal publishing to full open access highlight the need for large-scale studies assessing the adoption of open access in hybrid journals, including the extent to which transformative agreements contributed to it. Combining publicly available data from various sources, including cOAlition S Journal Checker, Crossref, and OpenAlex, this study presents a novel approach that leverages metadata from over 700 agreements and nine million journal articles.  Estimates suggest a strong growth in open access between 2018 and 2022 from 4.3\% to 15\%. In 2022, 58\% of open access articles could be attributed to transformative agreements. Growth can be largely attributed to three large commercial publishers: Elsevier, Springer Nature, and Wiley, but it varies substantially across journals, publishers, disciplines, and country affiliations. These estimates indicate that the current level of implementation of transformative agreements is insufficient to bring about a large-scale transition to full open access. In particular, different developments in the OECD and BRICS areas have the potential to hinder the transition of academic journal publishing. These findings are important for researchers and stakeholders engaged in negotiating and evaluating these agreements.}
