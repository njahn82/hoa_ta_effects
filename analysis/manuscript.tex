...
transformative agreements\footnote{In this paper I use the term
  ...
  (Borrego et al., 2020; Hinchliffe, 2019). Although the term is
...
open access publishing are considered together (Borrego et al., 2020;
...
access articles through transformative agreements, despite publishing
less than half of the total publication volume published between 2018
and 2022. This observation aligns with previous research on shifts in
the publishing market following the introduction of funding
...
agreements plays a lesser role compared to some European countries. The
smallest share of federally funded research was hybrid open access
between 2017 and 2021 (Schares, 2023). While some university consortia
like the California Digital Library signed transformative agreements,
others attempt to depart from big deals and unbundle large journal
portfolios to address cost increases (Brainard, 2021; Schares, 2022).
Despite the relatively low penetration of transformative agreements in
China and the United States compared to Europe, 22\% of open access in
hybrid journals in 2022 originates from these two countries, indicating
the availability of funding sources for publication fees.
...
cOAlition S, and not through invoicing data because these data a usually
not shared by publishers. Moreover, this study is unable to account for
the various types of transformative agreements, particularly with
regards to article types and capping. Similarly, assessing the quality
of the OpenAlex and Crossref data used, particularly in terms of
affiliations and article types, in comparison with established
bibliometric databases was beyond the scope of this analysis. Overall,
...
of publications as well as restrictions on migration flows, which could
have influenced the country-specific results (Aviv-Reuven \& Rosenfeld,
2021; Zhao et al., 2023). Furthermore, the study design did not consider
emerging publication practices such as preprints (Fraser et al., 2021)
and questionable special issues (Hanson et al., 2023), which have grown
particularly rapidly since 2020. Lastly, it should be emphasized that
the study aims to estimate articles enabled through transformative
agreements but does not address financial shifts due to a lack of data
on expenditures.
...
But the study also has practival implications for research funders and
libraries. Of primary concern should be observed differences across
...
access funding is not harmonised, but often crowd-sourced from various
sources. To improve the assessment of transformative agreements,
libraries and publishers could contribute by providing information about
respective journal portfolios, participating institutions and open
access invoicing.

In summary, the aim of this study was to provide empirical insights into
the developement of hybrid open access following the introduction of
transformative agreements. The results are important for both
researchers and stakeholders engaged in negotiating and evaluating these
agreements. The presented approach relies on open data, which enables
follow-up studies and open access monitoring acitvties to further
explore the role of transformative agreements in facilitating the shift
towards full open access in academic publishing.
