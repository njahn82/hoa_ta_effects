...
Although transformative agreements mainly bundle hybrid and subscription-only journals from commercial publishers, they aim at a higher degree of transparency than previous big deals, where contracts including payments were confidential [@Bergstrom_2014].
...
Specifically, they agreed to support hybrid open access solely through transformative agreements from 1 January 2021, until the end of 2024.
...
By the end of 2023, many transformative agreements were implemented, but outcomes were mixed.
...
However, with the growing trend toward transformative agreements, continued reliance on big deals is perceived as problematic, which might perpetuate market concentration [@Butler_2023; @Shu_2023]. 
...
Furthermore, the focus on large commercial publishers might increase inequality, because transformative agreements continue to target institutions from high-income countries [@Klebel_2023]. 
...
The consortium also removed most hybrid journals from its Transformative Journal program in 2023 due to their failure to meet self-defined open access growth targets [@Brainard_2023]. 
In contrast, the German DEAL consortium signed a five-year transformative agreement with Elsevier starting in 2024, while also renewing its contracts with Springer Nature and Wiley until the end of 2028.
...
Previous studies have focused on specific countries [@P_l_nen_2020; @Huang_2020; @Haucap_2021; @Wenaas_2022; @Taubert_2023] or publisher portfolios [@Pieper_2018; @Bakker_2024; @Fraser_2023; @Jahn_2021; @Momeni_2023], while related large-scale studies relied on self-reported agreement data [@Moskovkin_2022], or used APC pricing lists [@Shu_2023]. 
...
With this novel and open approach, this study aims to answer the following questions:

- What was the number and proportion of open access articles in hybrid journals included in transformative agreements between 2018 and 2022?
- How did transformative agreements impact open access uptake in hybrid journals?
...
First authors typically contribute most to a paper and are often considered lead author research papers [@Larivi_re_2016], and can be therefore assumed as a proxy to measure to open access payments [@Zhang_2022; @Shu_2023].
