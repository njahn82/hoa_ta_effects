...
Overall, this investigation established a link between open access articles and eligible institutions for `r n_tas_with_oa` out of `r length(unique(tas_in_esac_and_hoad_active_in_2018_22$ID))` active transformative agreements between 2018 and 2022 through the analysis of publication metadata, including affiliations and agreement data. 
