...
After making similar observations, Norwegian and Swedish universities and their consortia also argued for policy changes [@norway; @Widding_2024].
...
Data gathering started with obtaining journals included in transformative agreements from the publicly available Transformative Agreement Data dump used by the cOAlition S Journal Checker Tool[^tadump], a voluntary effort based on publicly disclosed contracts in the ESAC Transformative Agreement Registry[^esacregistry]. 
...
my_venn_df <- stack(my_venn)
write_csv(my_venn_df, here::here("analysis/fig_data", "fig_2A.csv"))
write_csv(cr_stats_plot$data, here::here("analysis/fig_data", "fig_2B.csv"))
```
...
Throughout this mostly automated data gathering and analysis process, Tidyverse tools [@tidyverse] for the R programming language [@r] were used. 
...
# Data export
write_csv(oa_ta_plot$data, here::here("analysis/fig_data", "fig_3A.csv"))
write_csv(ta_share_plot$data, here::here("analysis/fig_data", "fig_3B.csv"))
write_csv(oa_jn_box$data, here::here("analysis/fig_data", "fig_3C.csv"))
write_csv(box_ta_prop$data, here::here("analysis/fig_data", "fig_3D.csv"))
```
...
# Data backup
write_csv(publisher_prop$data, here::here("analysis/fig_data", "fig_4A.csv"))
write_csv(publisher_ta_prop_plot$data, here::here("analysis/fig_data", "fig_4B.csv"))
write_csv(publisher_boxplot$data, here::here("analysis/fig_data", "fig_4C.csv"))
```
...
write_csv(subject_trend_plot$data, here::here("analysis/fig_data", "fig_5A.csv"))
write_csv(subject_ta_trend_plot$data, here::here("analysis/fig_data", "fig_5B.csv"))
write_csv(subject_box_trend$data, here::here("analysis/fig_data", "fig_5C.csv"))
```
...
# Data backup
write_csv(country_bar$data, here::here("analysis/fig_data", "fig_6A.csv"))
write_csv(country_scatter_22$data, here::here("analysis/fig_data", "fig_6B.csv"))
write_csv(top_20_plot$data, here::here("analysis/fig_data", "fig_6C.csv"))
```
...
# Data backup 
write_csv(country_plot$data, here::here("analysis/fig_data", "fig_7.csv"))
```
...
Furthermore, the study design did not consider emerging publication practices such as preprints [@Fraser_2021] and special issues [@Hanson_2024], which have grown rapidly since 2020. 
...
The author confirms sole responsibility for the following: Conceptualization, Methodology, Formal analysis, Investigation, Data Curation, Writing - Original Draft, Writing - Review & Editing, Visualization.
...
This work was supported by the Deutsche Forschungsgemeinschaft (DFG, German Research Foundation), Project-ID 416115939.
