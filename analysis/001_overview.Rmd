...
What is the number and proportion of open access articles in hybrid journals published under a transformative agreement?
...
box_ta_prop <- summary_all |>
  ...
  scale_fill_manual("Hybrid OA", values = c(prop_no_ta = "#b3b3b3a0", prop_ta_oa = "#56B4E9"), labels = c(prop_no_ta = "Other", prop_ta_oa = "Agreement")) +
  theme_minimal() +
  labs(y = "OA Uptake\nper Hybrid Journal", x = "Publication Year")
