...
During this period, `r n_oa` out of `r n_total` articles in these journals became open access, representing a five-year hybrid open access uptake rate of `r n_oa / n_total * 100`%.
